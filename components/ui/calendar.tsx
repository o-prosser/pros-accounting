    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-border/50",
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent/20",
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-transparent !text-background hover:bg-primary/20 hover:text-primary-foreground focus:bg-accent/30 focus:text-primary-foreground",
        day_today: "bg-accent/15 text-background",
        day_outside:
